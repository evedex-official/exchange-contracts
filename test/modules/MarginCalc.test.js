  ...
  it('getMargin should accumulate previous levels', async () => {
    ...
    const marginLevels = [
      ...
      },
      {
        ...
        marginCoefficient: BigInt(2 * MARGIN_CALC_MARGIN_PRECISION),
      },
    ];
    ...
    const expectedMargin =
      ...
      (marginLevels[1].marginCoefficient * (positionVolume - marginLevels[1].positionVolumeLowerBound)) /
        BigInt(MARGIN_CALC_MARGIN_PRECISION);
